        ...
        <div class="container-fluid">
          ...
          <div class="nav-collapse">
            ...
            <li class="divider-vertical"></li>
              ...
              <li><a href="users_all.php">Display All</a></li>
              <li><a href="banned.php">Banned User</a></li>
              <li><a href="make_ann.php">Make Announcement</a></li>
            </ul>
          </div>
          <?php } ?>
        </div>
...
echo '<h3>Summary:</h3>';
echo 'There are <strong><u>'.$totaluser.' registered users</u></strong> and <strong><u>'.$totalban.' banned</u></strong>. | Display Mode: <strong>All rows</strong>';
echo '</div></div>';
echo '</div>';
