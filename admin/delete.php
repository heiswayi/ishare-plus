...
function renderForm($error, $deleteUser)
{
?>
<!DOCTYPE html>
<html lang="en">
...
<div class="row">
  ...
  ?>
  <p>
  You are going to delete this user: <strong><u><?php echo $deleteUser; ?></u></strong>. Please enter the access code for the verification! Deletion of this user will clear out all related data from the database.
  </p>
  <form action="" method="post">
              <div class="input-prepend">
                <input type="hidden" name="username" value="<?php echo $deleteUser; ?>">
  ...
  <p><a href="users.php">Cancel, just back to the Userlist!</a></p>
    ...
    if (isset($_GET['u'])) {
        ...
        if (!isset($_SESSION['userwd'])) { header('Location: ../404.php'); }
            ...
            if (mysql_num_rows($data) > 0 && in_array(strtolower($nick), $admin, true)) {
                if (isset($_SESSION['xuidPJVE218'])) { renderForm('', $deleteUser); }
