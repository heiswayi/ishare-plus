...
function renderForm($error, $filename)
{
?>
<!DOCTYPE html>
<html lang="en">
...
<div class="row">
  ...
  ?>
  <p>
  You are going to delete this file: <strong><u><?php echo $filename; ?></u></strong>. Please enter the access code for the verification! Deletion of this user will clear out all related data from the database.
  </p>
  <form action="" method="post">
              <div class="input-prepend">
                <input type="hidden" name="hfs_name" value="<?php echo $filename; ?>">
    ...
    if (isset($_GET['u'])) {
        ...
        if (!isset($_SESSION['userwd'])) { header('Location: ../404.php'); }
            ...
            if (mysql_num_rows($data) > 0 && in_array(strtolower($nick), $admin, true)) {
                if (isset($_SESSION['xuidPJVE218'])) { renderForm('', $filename); }
