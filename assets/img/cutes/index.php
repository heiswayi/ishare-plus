...
for ($i=1; $i<count($files); $i++) {
  ...
  //echo '&lt;img src="assets/img/smilies/' . $filename . '" onclick="insertSmiley(\'[;' . $onlyname . ';]\')" title="[;' . $onlyname . ';]" /&gt;';
  echo '&lt;img src="assets/img/cutes/' . $filename . '" onclick="insertSmiley(\'{;' . $onlyname . ';}\')" title="{;' . $onlyname . ';}" /&gt;';
  echo '<br />';
