...
function initialize() {
    ...
    var mapOptions = {
        zoom: 3,
        center: new google.maps.LatLng(5.151017599999999, 100.4962528),
...
function calcRoute() {
    ...
    directionsService.route(request, function (response, status) {
        ...
        else if (status == "NOT_FOUND") alert("At least one of the origin, destination, or waypoints could not be geocoded.");
