...
//shout messages
$result = mysql_query("SELECT * FROM i_shouts_gc ORDER BY id DESC LIMIT 15");
$lines  = array();
$i      = 1;
...
while ($userz = mysql_fetch_assoc($topuser)) {
    ...
    $noofmsg  = implode(mysql_fetch_assoc(mysql_query("SELECT COUNT(shout) FROM i_shouts_gc WHERE username='$username'")));
